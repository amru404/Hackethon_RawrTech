            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="services.html"><strong> services
                                </strong></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="about.html"><strong> About </strong></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="shop.html"><strong> Shop </strong></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="contact.html"><strong> Contact </strong></a>
                        </li>
                    </ul>
                    <form class="form-inline my-2 my-lg-0">
                        <div class="search_icon">
                            <ul>
                                <li><a href="#"><img src="{{ asset('asset_landing/images/search-icon.png') }}"></a></li>
        ...
        <div class="container">
            ...
            <div class="row">
               <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                ...
                <img src="{{asset('asset_landing/images/galery3.jpeg')}}"alt="Avatar" style="height:300px;" class="image" alt="...">
                <div class="card-body">
