...
<div class="card-body">
    <form action="{{ route('admin.order.update', $order->id)}}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="tanggal_ticket" value="{{ $order->tanggal_ticket}}"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select class="form-control" id="ticket_id" name="ticket_id" required>
                    <option value="{{ $order->ticket_id}}">{{$order->ticket->product->nama}} | <span
                            style="float:right">stock :
