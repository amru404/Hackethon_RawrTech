                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="container_main">
                            <img src="{{ asset('asset_landing/images/ecraft.jpeg') }}" alt="Avatar" class="image">
                            <div class="overlay">
                    ...
                    <div class="col-md-6">
                        <div class="container_main">
                            <img src="{{ asset('asset_landing/images/umkm.jpeg') }}" alt="Avatar" class="image">
                            <div class="overlay">
                                <a href="#" class="icon" title="User Profile">
                                    <i class="fa fa-search"></i>
                                </a>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mail_sectin">
                        ...
                        @csrf
                            <input type="text" class="email-bt" placeholder="Nama" name="nama" required>
                            <input type="email" class="email-bt" placeholder="Email" name="email" required>
                            <input type="number" class="email-bt" placeholder="Number Phone" name="no_hp" required>
